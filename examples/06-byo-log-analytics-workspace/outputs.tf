...
# Should equal `shared_log_analytics_workspace_id` — proves the module used
# the externally-provided LAW, not a self-created one. The integration test
# asserts on this equality.
...
# What we'd compare the module's output against to prove BYO LAW took effect.
